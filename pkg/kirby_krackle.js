...
* @param {number} spread
*/
export function generate_canvas(color1, color2, regions, density, spread) {
    ...
    wasm.generate_canvas(ptr0, len0, ptr1, len1, regions, density, spread);
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('kirby_krackle_bg.wasm', import.meta.url);
    }
    const imports = getImports();
